━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ZROS v2.8 — ZERO REWORK OPERATING SYSTEM
...
Version      : 2.8
Date         : April 13, 2026
Supersedes   : ZROS v2.7

WHAT CHANGED IN v2.8:
  NEW 1   L11 — Downloads-first file sourcing law (Windows Git Bash)
  NEW 2   T25 — File-not-found incident class
  NEW 3   G-FILE gate added to session start checklist
  NEW 4   Downloads path wired into all file commands
...
L11  Claude-produced files land in ~/Downloads/. Always source from there.
     On Windows Git Bash, every file Claude outputs is downloaded to
     ~/Downloads/ — NOT auto-placed in the repo directory.
     This is a permanent operational reality of the environment.

     RULE: Before ANY command that references a Claude-produced file,
     confirm it exists in ~/Downloads/ and copy it to the repo first.

     Standard copy sequence (run before every build/migration):
       ls ~/Downloads/<filename>*          # confirm download exists
       cp ~/Downloads/<filename> <repo-path>/<filename>
       # If browser saved as "name (1).go" use the highest-numbered version

     Docker migration sequence (SQL files never auto-mount):
       cp ~/Downloads/<file>.sql migrations/
       docker cp migrations/<file>.sql <container>:/tmp/
       docker exec <container> psql ... -f /tmp/<file>.sql
       # NOT: docker exec ... -f /migrations/<file>.sql  (no host mount)

     Violation: T25 — file not found, build fails, migration rolls back.
     Root cause confirmed: April 13, 2026 — C-5/C-6 implementation lost
     3 execution cycles to stale Downloads copies and wrong docker paths.
     Never repeated after this law is established.
...
Inherited from v2.6 (T13–T20), now extended:
  ...
  T25  File Not Found — Claude-produced file used before copying from Downloads
       Consequence: Build fails, migration rolls back, execution cycle wasted.
       Root cause: Claude outputs land in ~/Downloads/ not in the repo.
                   Commands run against repo path before cp from Downloads.
                   Docker exec paths assume host mounts that don't exist.
       Fix: Always run ls ~/Downloads/<file> before any command referencing it.
            Always cp from Downloads to repo before build/migration/docker cp.
       Gate: G-FILE (check Downloads before any file-dependent command)
       First occurrence: April 13, 2026 — C-5/C-6 session. 3 cycles lost.
...
15. G-FILE: All Claude-produced files sourced from ~/Downloads/ before use: YES / NO

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
END OF ZROS v2.8
Laws: L1–L11 | Incidents: T13–T25 | Gates: 19 total | 4 HARD STOPS
Paired with: APEX v5.2 + MASTER_LEARNINGS v2.1 DELTA
Upload to Claude project as: ZROS-v2.8-AgentRepEngine.md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━